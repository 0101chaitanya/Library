...
submit.addEventListener('click', e => this.formParse());
...
function formParse() {
    ...
    obj.author = 'adad'; //form.authorInput.textContent;
    obj.title = 'adad'; //form.titleInput.textContent;
    obj.pages = 2; //form.pagesInput.textContent;
    obj.refUrl = `http://127.0.0.1:5500/`;
    form.urlInput.textContent;
    obj.readStatus = true; //form.readInput.checked;
