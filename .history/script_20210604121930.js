...
let viewContainer = document.window.createElement('div');
...
function formSubmit() {
    ...
    red.id = `Red${i}`;
    viewContainer.appendChild(auth);
    viewContainer.appendChild(ttl);
    viewContainer.appendChild(pgs);
    viewContainer.appendChild(url);
    viewContainer.appendChild(red);
