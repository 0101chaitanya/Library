...
submitBtn.addEventListener('click', addBook(form)); //console.log(ObjArray.length);

function addBook(form) {
    let obj = new setBookObj(form.elements[0].textContent, form.elements[1].textContent, form.elements[2].value, form.elements[4].checked);
    console.log(obj);
