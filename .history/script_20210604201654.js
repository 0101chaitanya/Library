...
function addBook() {
    ...
    obj.author = this.form.elements[0].value;
    obj.title = this.form.elements[1].value;
    obj.pages = this.form.elements[2].value;
    obj.readStatus = this.form.elements[3].value;
    ObjArray.push(obj);
    e.target.submit();
}
