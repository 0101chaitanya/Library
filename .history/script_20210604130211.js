...
function formParse(e) {
    ...
    obj.authorInput = e.authorInput.textContent;
    obj.titleInput = e.titleInput.textContent;
    obj.pagesInput = e.pagesInput.textContent;
    obj.urlInput = e.urlInput.textContent;
    obj.readInput = e.readInput.textContent;
