...
submitBtn.addEventListener('click',
    function() {
        let inputElem = Array.from(form.elements);

        let obj = new setBookObj(inputElem[0].value, inputElem[1].value, inputElem[2].value, inputElem[3].checked);
        console.log(obj);

        objArray.push(obj);
        localStorage.setItema(obj.)
        form.submit();
