...
let author = createElmt('author', 'author', 'text', 'Author:', 'authorInput', 'authorInput');
let title = createElmt('title', 'title', 'text', 'Title:', 'titleInput', 'titleInput');

let pages = createElmt('pages', 'pages', 'number', 'Pages:', 'pagesInput', 'pagesInput');
let read = createElmt('read', 'read', 'checkbox', 'Read:', 'readInput', 'readInput');
