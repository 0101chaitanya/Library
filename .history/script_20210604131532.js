...
formEnable();
//formSubmit();
function formSubmit(i, auth, ttl, pgs, ul, red,
    div, this.aI, this.tI, this.pI, this.uI, this.rI) {
    div = document.createElement('div');
    auth = document.createElement('p');
    auth.classList.add(`book${i}`);
    auth.textContent = obj.aI;
...
function formParse(event) {
    ...
    obj.author = event.authorInput.textContent;
    obj.title = event.titleInput.textContent;
    obj.pages = event.pagesInput.textContent;
    obj.refUrl = event.urlInput.textContent;
    obj.readStatus = event.readInput.checked;
