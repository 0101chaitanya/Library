...
function formParse(event) {
    ...
    obj.aI = event.authorInput.textContent;
    obj.tI = event.titleInput.textContent;
    obj.pI = event.pagesInput.textContent;
    obj.uI = event.urlInput.textContent;
    obj.rI = event.readInput.checked;
